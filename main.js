...
var vacum=[[-23,-21],[-22,-21],[2,-21],[3,-21],[-23,-20],[-22,-20],[2,-20],[0,-19],[2,-19],[-9,-18],[-8,-18],[0,-18],[1,-18],[-24,-17],[-23,-17],[-9,-17],[-7,-17],[-24,-16],[-23,-16],[-9,-16],[-7,-16],[-6,-16],[-8,-15],[-7,-15],[-8,-14],[20,-13],[21,-13],[-8,-12],[20,-12],[21,-12],[-8,-11],[-7,-11],[-24,-10],[-23,-10],[-9,-10],[-7,-10],[-6,-10],[8,-10],[12,-10],[-24,-9],[-23,-9],[-9,-9],[-7,-9],[7,-9],[13,-9],[21,-9],[22,-9],[-9,-8],[-8,-8],[7,-8],[21,-8],[22,-8],[7,-7],[8,-7],[12,-7],[-23,-6],[-22,-6],[9,-6],[10,-6],[11,-6],[-23,-5],[-22,-5],[9,-4],[10,-4],[11,-4],[7,-3],[8,-3],[12,-3],[7,-2],[21,-2],[22,-2],[7,-1],[13,-1],[21,-1],[22,-1],[8,0],[12,0],[20,2],[21,2],[20,3],[21,3],[13,8],[14,8],[13,9],[15,9],[23,9],[24,9],[15,10],[23,10],[24,10],[13,11],[14,11],[15,11],[-2,12],[0,12],[-3,13],[-2,13],[-1,13],[-3,14],[-2,14],[-1,14],[-3,15],[13,15],[14,15],[15,15],[1,16],[3,16],[15,16],[-3,17],[-2,17],[3,17],[13,17],[15,17],[-8,18],[-7,18],[-2,18],[2,18],[3,18],[13,18],[14,18],[-9,19],[-7,19],[0,19],[-9,20],[-10,21],[-9,21]];
	...
	var plan = [
		{'shape':gosperGliderGun,c:100,r:30,rotate:true,flipHorizontal:false,flipVertical:false},
		{'shape':gosperGliderGun,c:150,r:30,rotate:true,flipHorizontal:false,flipVertical:false},
		{'shape':gosperGliderGun,c:200,r:30,rotate:true,flipHorizontal:false,flipVertical:false},
		{'shape':gosperGliderGun,c:250,r:30,rotate:true,flipHorizontal:false,flipVertical:false}
	];
	
	var repeating = [
		{'shape':lightweight_spaceship,c:10,r:10,rotate:true,flipHorizontal:false,flipVertical:true},
		{'shape':lightweight_spaceship,c:20,r:10,rotate:true,flipHorizontal:false,flipVertical:true},
		{'shape':lightweight_spaceship,c:30,r:10,rotate:true,flipHorizontal:false,flipVertical:true},
		{'shape':lightweight_spaceship,c:40,r:10,rotate:true,flipHorizontal:false,flipVertical:true},
		{'shape':lightweight_spaceship,c:50,r:10,rotate:true,flipHorizontal:false,flipVertical:true},
		{'shape':lightweight_spaceship,c:60,r:10,rotate:true,flipHorizontal:false,flipVertical:true},
	];
	...
	function cb(data) {
		...
		if (isPlan){
			...
			pixels = tryPlacePattern(data,repeating[planIndex])		
			if (pixels.length > 0){			
				planIndex = (planIndex+1) % repeating.length;			
			}
		}
	...
	function insertPatternByArray(pattern){
		...
		for (i in pattern.shape){
			if (pattern.rotate)
				retArray.push([col+flipH * pattern.shape[i][1],row-flipV *pattern.shape[i][0]]);
			else
